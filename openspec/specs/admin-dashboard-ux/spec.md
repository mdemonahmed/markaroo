...
Redesigned admin dashboard shell: a consistent icon-led navigation with deep-linkable views, a leaner Overview whose stats link into filtered lists, and a shared centered detail modal for feedback items across All Feedback, Approvals, and Board.
