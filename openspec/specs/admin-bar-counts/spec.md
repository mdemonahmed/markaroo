# admin-bar-counts Specification

## Purpose

Surface the open-feedback count for the current page in the WordPress admin bar for authorized reviewers, sourced from the existing transient-cached counts with no extra queries on a warm cache.
