# pin-clustering Specification

## Purpose

Keep pages with many feedback pins performant by clustering nearby pins client-side above a threshold, while preserving the existing memoized per-marker rendering.
