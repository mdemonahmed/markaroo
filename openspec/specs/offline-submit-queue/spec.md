# offline-submit-queue Specification

## Purpose

Make feedback submission resilient to transient network failures by queuing failed submissions and retrying them with backoff, while keeping screenshot Blobs in memory and only persisting lightweight metadata.
