# feedback-status-board Specification

## Purpose

Provide a Kanban-style status board in the dashboard where feedback is organized into per-status columns and can be moved between statuses by dragging cards.
