...
export function PinMarker( { item, number, dimmed, active, canDrag, onClick, onMove, onResolve }: Props ) {
	const pinRef   = useRef< HTMLButtonElement >( null );
	const dragRef  = useRef< { startX: number; startY: number; pinX: number; pinY: number } | null >( null );
